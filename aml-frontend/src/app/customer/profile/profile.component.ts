...
@Component({
              ...
              <div *ngIf="!isLoading && !isEditMode && profileData" class="profile-display">
                ...
                <div class="mb-4">
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-sm-8">{{ profileData.username }}</div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-4"><strong>Phone:</strong></div>
                    <div class="col-sm-8">{{ profileData.phone }}</div>
                  </div>
                </div>
                ...
                <div class="mb-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">{{ profileData.address.street || 'N/A' }}</div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-4"><strong>City:</strong></div>
                    <div class="col-sm-8">{{ profileData.address.city }}</div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-4"><strong>State:</strong></div>
                    <div class="col-sm-8">{{ profileData.address.state }}</div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-4"><strong>Country:</strong></div>
                    <div class="col-sm-8">{{ profileData.address.country }}</div>
                  </div>
                  <div class="row mt-2">
                    <div class="col-sm-4"><strong>Postal Code:</strong></div>
                    <div class="col-sm-8">{{ profileData.address.postalCode }}</div>
                  </div>
                </div>
                ...
                <div class="mb-4">
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-sm-8">{{ formatDate(profileData.createdAt) }}</div>
                  </div>
                </div>
              </div>
  ...
  styles: [`
    ...
    .profile-display .row:last-child {
      border-bottom: none;
    }
